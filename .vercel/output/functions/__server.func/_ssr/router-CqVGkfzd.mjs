...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CqVGkfzd.js
...
var $$splitComponentImporter$7 = () => import("./routes-Bs5Mu4zg.mjs");
...
var $$splitComponentImporter$5 = () => import("./auth-aofjlA8h.mjs");
...
var $$splitComponentImporter$4 = () => import("./dashboard-DWBzwkvj.mjs");
...
var $$splitComponentImporter$3 = () => import("./family-Bywi0X1V.mjs");
...
var $$splitComponentImporter$2 = () => import("./library-DFp1Qg8I.mjs");
...
var $$splitComponentImporter$1 = () => import("./playlists-r6hXPxiR.mjs");
...
var $$splitComponentImporter = () => import("./settings-CrjmrNrl.mjs");
...
var Route = createFileRoute("/api/yoto/callback")({ server: { handlers: { GET: async ({ request }) => {
	...
	if (new Date(row.expires_at).getTime() < Date.now()) return new Response("Expired state", { status: 400 });
