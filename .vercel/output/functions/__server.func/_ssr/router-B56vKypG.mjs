...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B56vKypG.js
...
var styles_default = "/assets/styles-B3L0NUr6.css";
...
function ErrorComponent({ error, reset }) {
	...
	if (error?.message?.includes("Supabase environment variable") || error?.message?.includes("Supabase client is not configured") || error?.message?.includes("Missing Supabase environment variable")) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "flex min-h-screen items-center justify-center bg-background px-4",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "max-w-md rounded-2xl border border-border bg-card p-6 shadow-xl text-center",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "Connect Supabase to proceed"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 text-sm text-muted-foreground",
					children: "This application requires a Supabase connection to store players, playlists, and cards."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-5 text-left rounded-lg bg-muted/60 p-4 border border-border/40 text-xs text-muted-foreground space-y-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-semibold text-foreground",
							children: "How to fix this on Vercel:"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
							className: "list-decimal list-inside space-y-1.5 leading-relaxed",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["Add the following environment variables:", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
									className: "list-disc list-inside pl-4 mt-1 space-y-1 text-[11px] font-mono",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
										className: "text-foreground",
										children: "SUPABASE_URL"
									}), ": your-supabase-project-url"] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
										className: "text-foreground",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
									...
									" tab and redeploy the latest commit to apply the changes."
								] })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "pt-2 text-[11px] leading-relaxed border-t border-border/20",
							children: [
								"💡 ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Pro tip:" }),
								" If using Lovable, click \"Connect Supabase\" in the Lovable editor to automatically configure these variables for you."
							]
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: "Try again after setting variables"
					})
				})
			]
		})
...
function RootShell({ children }) {
	const supabaseUrl = typeof process !== "undefined" ? process.env.SUPABASE_URL : void 0;
	const supabasePublishableKey = typeof process !== "undefined" ? process.env.SUPABASE_PUBLISHABLE_KEY || process.env.SUPABASE_ANON_KEY : void 0;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		lang: "en",
		className: "dark",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("head", { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}),
			supabaseUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("script", { dangerouslySetInnerHTML: { __html: `window.__SUPABASE_URL__ = ${JSON.stringify(supabaseUrl)};` } }),
			supabasePublishableKey && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("script", { dangerouslySetInnerHTML: { __html: `window.__SUPABASE_PUBLISHABLE_KEY__ = ${JSON.stringify(supabasePublishableKey)};` } })
...
var $$splitComponentImporter$7 = () => import("./auth-DEyPd43j.mjs");
...
var $$splitComponentImporter$5 = () => import("./routes-ddwmPhz6.mjs");
...
var $$splitErrorComponentImporter$3 = () => import("./settings-CyNg9cnO.mjs");
var $$splitComponentImporter$4 = () => import("./settings-1TS6yncT.mjs");
...
var $$splitErrorComponentImporter$2 = () => import("./playlists-CY5NUkbh.mjs");
var $$splitComponentImporter$3 = () => import("./playlists-C2v7rz1M.mjs");
var Route$5 = createFileRoute("/_authenticated/playlists")({
...
var $$splitComponentImporter$2 = () => import("./library-BTG01fCh.mjs");
...
var $$splitErrorComponentImporter$1 = () => import("./family-BjW_el_K.mjs");
var $$splitComponentImporter$1 = () => import("./family-4wkHUYZS.mjs");
var Route$3 = createFileRoute("/_authenticated/family")({
...
var $$splitErrorComponentImporter = () => import("./dashboard-DrY73j3E.mjs");
var $$splitComponentImporter = () => import("./dashboard-Oq7S1zNH.mjs");
...
*/
var Route$1 = createFileRoute("/api/yoto/callback")({ server: { handlers: { GET: async ({ request }) => {
...
*/
var Route = createFileRoute("/api/yoto/authorize")({ server: { handlers: { GET: async ({ request }) => {
	const url = new URL(request.url);
...
var AuthenticatedPlaylistsRoute = Route$5.update({
	id: "/playlists",
	path: "/playlists",
	getParentRoute: () => AuthenticatedRouteRoute
});
...
var AuthenticatedFamilyRoute = Route$3.update({
	id: "/family",
	path: "/family",
	getParentRoute: () => AuthenticatedRouteRoute
});
...
var ApiYotoCallbackRoute = Route$1.update({
	id: "/api/yoto/callback",
	path: "/api/yoto/callback",
	getParentRoute: () => Route$10
});
var ApiYotoAuthorizeRoute = Route.update({
